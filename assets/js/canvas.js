...
var vy;
// gravedad alterada
var g1 = document.getElementById("r1")
var gravity = Number(g1.value);
document.getElementById("gg").innerText = gravity

function range(data){
    document.getElementById("gg").innerText = data
    console.log("gg", gravity)
    return gravity = Number(data);
}
// var gravity = Number(g1.value);
